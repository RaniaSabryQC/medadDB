...
<@layout.registrationLayout displayMessage=messagesPerField.exists('global') displayRequiredFields=false; section>
	<#if section = "header">
		...
		<#else>
			${msg("registerTitle")}
				<div id="kc-form-options" class="back-to-previous-step">
					<div class="${properties.kcFormOptionsWrapperClass!}">
						<span><a href="${url.loginRestartFlowUrl}" class="back">${msg("backToPreviousStep")}</a></span>
					</div>
				</div>
		</#if>
	<#elseif section = "form">
							...
							<div class="${properties.kcInputWrapperClass!}">
								<div class="${properties.kcInputGroup!}" dir="ltr">
									...
									<button class="${properties.kcFormPasswordVisibilityButtonClass!}" type="button"
													...
													tabindex="4" aria-controls="password" data-password-toggle
